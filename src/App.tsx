        ...
        <section id="contact" className="content-section cta-section">
          <div className="container contact-shell">
            ...
            <div className="contact-icons-row">
              <a
                href="mailto:johnmichealeco@gmail.com"
                aria-label="Email johnmichealeco@gmail.com"
                title="Email: johnmichealeco@gmail.com"
              ...
              <a
                href="tel:09088939571"
                aria-label="Call 09088939571"
                title="Phone: 09088939571"
                className="social-icon-link"
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                href="https://www.facebook.com/johnmicheal.eco/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook Profile"
                title="Facebook: johnmicheal.eco"
